...
module.exports = resumable = function(temporaryFolder){
  ...
  rename = function(oldFilename, newFilename, callback){
    var is = fs.createReadStream(oldFilename);
    var os = fs.createWriteStream(newFilename);
  ...
  $.post = function(req, callback){
    ...
    if(validation=='valid') {
      ...
      rename(files[$.fileParameterName].path, chunkFilename, function(err){
